<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.Master" AutoEventWireup="true" CodeBehind="CatalogoTipoPago.aspx.cs" Inherits="ProyectoIntegrador.GUI.CatalogoTipoPago" %>
                                 ...
                                 <div class="col-md-12">
                                     <div class="panel-body">
                                          <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                 ...
                                                 <asp:GridView ID="GrTipo" CssClass="table table-bordered table-striped" runat="server" AutoGenerateColumns="False" DataKeyNames="IdTipoPago" OnRowCommand="grResultado_RowCommand" OnRowDeleting="GrTipo_RowDeleting" >
                                         <Columns>
                                             <asp:BoundField DataField="IdTipoPago" HeaderText="CLAVE" SortExpression="IdSitio" />
                                             ...
                                             <asp:ButtonField ButtonType="Button" CommandName="BORRA" HeaderText="ELIMINAR" ShowHeader="True" Text="ELIMINAR" />
