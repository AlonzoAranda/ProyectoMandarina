...
*/!function (e) {
    var i = 'style="width:{width};height:{height};"',
        ...
        o = {
            ...
            image: function (e, i) { return "undefined" != typeof e ? e.match("image.*") : i.match(/\.(gif|png|jpe?g)$/i) },
        ...
        d = function (i, t) { return null === i || void 0 === i || i == [] || "" === i || t && "" === e.trim(i) },
        c = function (e) { return Array.isArray(e) || "[object Array]" === Object.prototype.toString.call(e) },
        v = function (e, i) { return "object" == typeof i && e in i }, m = function (i, t, a) { return d(i) || d(i[t]) ? a : e(i[t]) },
        u = function () { return Math.round((new Date).getTime() + 100 * Math.random()) },
        g = function () { return window.File && window.FileReader && window.FileList && window.Blob },
        w = window.URL || window.webkitURL, f = function (i, t) { this.$element = e(i), g() ? (this.init(t), this.listen()) : this.$element.removeClass("file-loading")
        };
    f.prototype = {
        constructor: f, init: function (e) {
            var i = this; i.reader = null, i.showCaption = e.showCaption, i.showPreview = e.showPreview,
            ...
            i.previewSettings = e.previewSettings, i.fileTypeSettings = e.fileTypeSettings,
            i.showRemove = e.showRemove, i.showUpload = e.showUpload,
            i.captionClass = e.captionClass, i.previewClass = e.previewClass,
            ...
            i.isError = !1, i.isDisabled = i.$element.attr("disabled") || i.$element.attr("readonly"),
            d(i.$element.attr("id")) && i.$element.attr("id", u()), "undefined" == typeof i.$container ?
            i.$container = i.createContainer() : i.refreshContainer(), i.$captionContainer = m(e, "elCaptionContainer",
                i.$container.find(".file-caption")), i.$caption = m(e, "elCaptionText",
