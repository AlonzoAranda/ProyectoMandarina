...
<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.Master" AutoEventWireup="true" CodeBehind="CatalogoEstablecimientos.aspx.cs" Inherits="ProyectoIntegrador.GUI.CatalogoEstablecimientos" %>
                                ...
                                <div class="panel-body">                                                                        
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">  
                                                    <asp:DropDownList ID="ddlTipo" class="form-control" runat="server" AutoPostBack="True"></asp:DropDownList>
                                 ...
                                 <div class="col-md-12">
                                     <div class="panel-body">
                                          <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                 ...
                                                 <asp:GridView ID="GrTipo" CssClass="table table-bordered table-striped" runat="server" AutoGenerateColumns="False" DataKeyNames="IdEstablecimiento" OnRowCommand="grResultado_RowCommand" OnRowDeleting="GrTipo_RowDeleting" >
                                             <Columns>
                                             <asp:BoundField DataField="IdEstablecimiento" HeaderText="CLAVE" SortExpression="IdSitio" />
                                             <asp:BoundField DataField="Nombre" HeaderText="NOMBRE" SortExpression="Nombre" />

                                             <asp:BoundField DataField="NombreTipo" HeaderText="TIPO DE ESTABLECIMIENTO" SortExpression="NombreTipo" />

                                             <asp:ButtonField ButtonType="Button" CommandName="SELC" HeaderText="SELECCIONAR" ShowHeader="True" Text="SELECCIONAR" />
                                             <asp:ButtonField ButtonType="Button" CommandName="DEL" HeaderText="ELIMINAR" ShowHeader="True" Text="ELIMINAR" />
